...
-- Convert existing tables to utf8mb4 (safe to re-run)
ALTER TABLE users CONVERT TO CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
ALTER TABLE buses CONVERT TO CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
ALTER TABLE seats CONVERT TO CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
